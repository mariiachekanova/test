...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Premium Subscriptions Store', url: 'https://premiumsubscriptions.store' }],
  creator: 'Premium Subscriptions Store',
  publisher: 'Premium Subscriptions Store',
  metadataBase: new URL('https://premiumsubscriptions.store'),
  alternates: {
    canonical: '/',
  },
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://premiumsubscriptions.store',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              logo: 'https://www.premiumsubscriptions.store/android-chrome-512x512.png',
              ...
              contactPoint: {
                ...
                email: 'support@premiumsubscriptions.store',
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                ...
                target: {
                  '@type': 'EntryPoint',
                  urlTemplate: 'https://www.premiumsubscriptions.store/search?q={search_term_string}',
                },
