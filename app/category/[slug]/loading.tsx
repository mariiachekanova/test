      ...
      <main className="animate-pulse">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-6">
          <div className="rounded-2xl bg-card border border-border/60 p-6 sm:p-8">
            <div className="flex items-center gap-6">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-secondary shrink-0" />
              <div className="flex-1 space-y-3">
                <div className="h-7 sm:h-9 w-2/3 bg-secondary rounded-lg" />
                <div className="h-4 w-full max-w-md bg-secondary/60 rounded" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2.5 sm:gap-3">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="h-16 rounded-xl bg-card border border-border/60" />
            ))}
          </div>
        </div>
